// -----------------------------------------------------------------------------
// ParallaxScrollView.tsx - ScrollView with animated parallax header
// -----------------------------------------------------------------------------
// Provides a scrollable view with a parallax header image and animated effects.
// Used for activity detail and profile screens.
//
// Props:
//   - headerImage: React element for the header
//   - headerBackgroundColor: theme colors for header
